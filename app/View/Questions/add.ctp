<?php
  ...
  echo "<thead>";
  echo $this->Html->tableHeaders(array('', __('Answer'), __('Correct?'), __('Response')));
  echo "</thead>";
  echo "<tbody>";
  ...
  for ($i = 0; $i <= 1; $i++) {
    $answer_fields[$i] = array(
      ...
      $this->Form->input("Answer.$i.answer", array('label' => false, 'placeholder' => __('Answer text')/*, 'class' => 'mceQuickHelpSimple'*/)),
      ...
      $this->Form->input("Answer.$i.response_heading", array('label' => false, 'div' => false, 'placeholder' => __('Response heading')/*, 'class' => 'mceQuickHelpSimple'*/)).
      $this->Form->input("Answer.$i.response", array('label' => false, 'div' => false, 'placeholder' => __('Response text')/*, 'class' => 'mceQuickHelpSimple'*/)),
